...
class ChirpNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)
        self.layer1 = self._make_layer(block, 64, layers[0])
        self.layer2 = self._make_layer(block, 125, layers[1], stride=1)
...
class Heatmap(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1 = DCN(in_channels, in_channels, kernel_size=3, stride=(1, 1), padding=(1,1))
        self.bn1 = nn.BatchNorm2d(in_channels)
        self.conv2 = DCN(in_channels, out_channels, kernel_size=1, stride=(1, 1))
...
class Deconv(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1 = DCN(in_channels, out_channels, kernel_size=3, stride=(1, 1), padding=(1,1))
